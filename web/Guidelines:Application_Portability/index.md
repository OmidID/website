...
-   [X-Develop](http://www.omnicore.com/xdevelop.htm) from Omnicore is a
...
In addition, code that manually scans for path separators must be
changed, for example:
...
If you need to locate some services, you should use the proper .NET
