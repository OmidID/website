...
There is an ongoing effort part of Mono called the
...
There are two main reasons not to include "defaults" root certificates
in Mono.
...
With the CLR 1.x a security permission object (implementing
