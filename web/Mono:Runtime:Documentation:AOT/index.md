...
When the runtime loads a class, it needs to compute a variety of
...
The variable representing the got is stored in cfg-\>got\_var. It is
...
-   Currently, when an AOT module is loaded, all of its dependent
