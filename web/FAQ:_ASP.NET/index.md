...
To run ASP.NET 2.0 applications use mod-mono-server2 (for Apache),
...
If you are running mod\_mono with Apache, you must use the **MonoDebug**
...
''' Is it possible to have different ASP.NET configuration for different
