...
To avoid this problem you can use the `hostname` command to make sure
...
So you now have a "secure" connection. But what does secure means ?
...
So the **--https-client-accept** option isn't really interesting for web
