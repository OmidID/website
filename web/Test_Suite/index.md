...
<bash> \$ cd mcs/class/corlib \$ make run-test PROFILE=net\_2\_0 </bash>
...
[<b>mcs/class/doc/TemplateTest.cs</b>]({{site.url}}/TemplateTest.cs "wikilink")
...
Do not compare two values with Assert.IsTrue() - if the test fails,
